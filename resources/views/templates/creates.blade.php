        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
                    <div class="card-body">
                    <form method="post" action="templates/creates" >			
                  {{ csrf_field() }}  					
                  ...
                  <div class="row">
                  <div class="col-md-3">
                    <label for="exampleInputEmail1">Seleccione el Servicio:</label>
                  <select class="form-control" data-placeholder="Seleccione" style="width: 100%;" name="servicio" required>
