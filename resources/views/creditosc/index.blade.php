  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Facturas por Cobrar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    @include('flash-message')
      ...
      <div class="card">
              ...
              <form method="get" action="creditos_cobrar">					
              ...
              <label><input type="checkbox" id="checkTodos" />Seleccionar Todos</label>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    <td style="width: 2%"><input value="{{$an->id}}" type="checkbox" name="com[]"></td>
                    <td>{{$an->id}}</td>
                    <td>{{$an->created_at}}</td>
                    <td>{{$an->apellidos}} {{$an->nombres}}</td>
                    <td width="20%">{{$an->lasto}} {{$an->nameo}}</td>
                    <td width="30%">{{$an->detalle}}</td>
