    ...
    <section class="content">
      ...
      <div class="card">
              <div class="card-header">
                <a class="btn btn-primary btn-sm" href="{{route('solicitudes.create')}}">
                              <i class="fas fa-folder">
                              </i>
                              Agregar
                          </a>
                          <form method="get" action="solicitudes">					
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a class="btn btn-info btn-sm" id="{{$so->id}}" onclick="view(this)">
                          ...
                          @if($so->es_pagado == 0)
                          <a class="btn btn-success btn-sm" href="solicitudes-pagar-{{$so->id}}" onclick="return confirm('¿Desea Pagar esta solicitud?')">
